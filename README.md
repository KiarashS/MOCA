  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        ...
        <li><a href="#projects-section">Projects Section</a></li>
        <li><a href="#presentations-section">Presentations Section</a></li>
        ...
        <li><a href="#useful-links-section">Useful Links Section</a></li>
...
[![Product Name Screen Shot][product-screenshot]](img/doc/Screenshot.png)
